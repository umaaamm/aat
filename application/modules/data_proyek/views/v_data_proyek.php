...
$(document).ready(function() {
    ...
    formInput.validate({
        ...
        messages: {
            insert_id_rekanan_perusahaan: "Pilih perusahaan rekanan!",
    ...
    formEdit.validate({
        rules: {
            edit_id_rekanan_perusahaan: "required",
        ...
        messages: {
            edit_id_rekanan_perusahaan: "Pilih perusahaan rekanan!",
...
const showModal = (id) => {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#edit_perusahaan_rekanan').val(response.data.id_perusahaan_rekanan);
                        ...
                        <form id="insert_data_proyek_form">
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-control digits" name="insert_id_rekanan_perusahaan"
                                        id="perusahaan_rekanan">
                                        <option value="-">- Pilih Salah Satu -</option>
                                        <?php 
                                    foreach($getPerusahaanRekanan as $row):?>
                                        <option value="<?php echo $row->id_perusahaan_rekanan;?>">
                                            <?php echo $row->nama_perusahaan;?></option>
                                        <?php endforeach;?>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control" type="text" placeholder="Nama Proyek"
                                        name="insert_nama_proyek" required="Nama Proyek Tidak Boleh Kosong">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <label for="insert_nama_pic_proyek">Nama PIC Proyek</label>
                                    <input class="form-control" type="text" placeholder="Nama PIC Proyek"
                                        name="insert_nama_pic_proyek" required="Nama PIC Proyek Tidak Boleh Kosong">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <label for="insert_no_hp_pic_proyek">No Hp PIC Proyek</label>
                                    <input class="form-control" type="text" placeholder="No Hp PIC Proyek"
                                        name="insert_no_hp_pic_proyek" required="No Hp PIC Proyek Tidak Boleh Kosong">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <label for="insert_alamat_proyek">Alamat Proyek</label>
                                    <textarea class="form-control" name="insert_alamat_proyek" rows="3"
                                        placeholder="Alamat Proyek"></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 mb-3">
                ...
                <form id="edit_data_proyek_form">
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <select class="form-control digits" name="edit_id_rekanan_perusahaan"
                                id="edit_perusahaan_rekanan">
                                <option value="-">- Pilih Salah Satu -</option>
                                <?php 
                                    foreach($getPerusahaanRekanan as $row):?>
                                <option value="<?php echo $row->id_perusahaan_rekanan;?>">
